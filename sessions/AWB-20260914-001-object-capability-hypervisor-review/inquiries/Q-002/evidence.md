...
| AWB-20260914-001-E0031 | External primary | Direct | `https://groups.google.com/g/cap-talk`; `https://groups.google.com/robots.txt` | Checked 2026-09-15 | The candidate modern cap-talk group landing page is publicly retrievable. Google Groups permits `/g/` paths for crawlers but disallows its search endpoints, so permitted thread/message retrieval followed by local search is the bounded passive method. | public | unknown | The group has not yet been verified as the canonical continuation, and its thread coverage and content were not reviewed in this update. |
...
| ACTIVITY-003 | 2026-09-15 | Analysis orchestrator | Added a superseding access observation for the candidate modern cap-talk group. | E0031 qualifies the earlier inaccessible-route characterization without closing the content gap. |
