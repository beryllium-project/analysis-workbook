# Fixture question two - Search log
...
| --- | --- | --- | --- | --- | --- | --- |
| LQ-003 | 2000-01-01 | Fixture | `fixture://surface-two` | marker | Found the marker value. | AWB-20000101-001-E0003 |
| LQ-004 | 2000-01-01 | Fixture | `fixture://surface-one` | marker | No marker was recorded on this surface. | None |
...
| --- | --- | --- | --- |
| GAP-002 | A second fixture revision. | A later fixture snapshot. | Deferred; external research was not permitted. |
...
| ACTIVITY-002 | 2000-01-01 | Analysis agent | Recorded LQ-003 and LQ-004. | Synthetic fixture. |
