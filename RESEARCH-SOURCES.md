...
| 4 | `../project-manager/HANDOFF.md`, `../project-manager/records/`, `../project-manager/queue/LEDGER.md`, `../project-manager/outbox/component-requests.md`, `../COMPONENTS.md`, `../SOT.md` | Project Manager handoff, decision and assurance-transfer records, queue ledger and owner requests, component registry, workspace state, and canonical topology. The parent `../HANDOFF.md` remains a compatibility redirect; the former `../formal-verification/` redirects were retired by `../project-manager/records/decisions/PMD-20260912-001-retire-formal-verification-redirects.md`, so current assurance lookup uses `../project-manager/records/assurance/` directly | Read-only from this component. `../project-manager/` is the independent Project Manager component registered in `../COMPONENTS.md`, which records its exact revision. Parent and Project Manager coordination changes are the Project Manager's, not this agent's. |
