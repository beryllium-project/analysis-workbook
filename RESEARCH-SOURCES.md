...
| 4 | `../formal-verification/`, `../HANDOFF.md`, `../COMPONENTS.md`, `../SOT.md` | Project Manager assurance-transfer records, component registry, workspace state, and canonical topology | Read-only from this component. Parent coordination changes are the Project Manager's, not this agent's. |
